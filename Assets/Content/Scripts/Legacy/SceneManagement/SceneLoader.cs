...
namespace Content.Scripts.SceneManagement
{
    public class SceneLoader : MonoBehaviour
    {
        ...
        public async UniTask LoadScene(TypeScene typeScene)
        {
            ...
            _isLoading = true;
            await _sceneManager.LoadScene(_sceneGroup, loadingProgress, typeScene, _saveSlot, _saveType);
            _isLoading = false;
        ...
        public void SetSaveParameters(ESaveType saveType, ESaveSlot saveSlot) => (_saveSlot, _saveType) = (saveSlot, saveType);
    }
}